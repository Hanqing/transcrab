...
*   [Everything is broken](#toc_0)
*   [How we should not work with agents and why](#toc_1)
    *   [Compounding booboos with zero learning, no bottlenecks, and delayed pain](#toc_2)
    *   [Merchants of learned complexity](#toc_3)
    *   [Agentic search has low recall](#toc_4)
*   [How we should work with agents (for now, I think)](#toc_5)
